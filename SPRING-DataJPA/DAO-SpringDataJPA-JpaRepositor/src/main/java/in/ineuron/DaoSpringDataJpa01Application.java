...
//		 CoronaVaccine("covidshield","serum","kkk",450.0,2);
//		
//		  CoronaVaccine vaccine = new CoronaVaccine(); 
//		  vaccine.setPrice(450.0);
//		  service.searchVaccinesByGivenData(vaccine, false,"price","name").forEach(System.out::println);
		...
		/*
		 * List<Long> list = new ArrayList<Long>(); list.add(6L); list.add(7L);
		 * list.add(8L); System.out.println(service.removeVaccinesByRegNo(list));
		 */
