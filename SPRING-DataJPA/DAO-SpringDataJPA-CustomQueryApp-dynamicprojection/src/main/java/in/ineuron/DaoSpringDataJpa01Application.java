...
//		service.searchVaccineByCompany("ena"  , ResultView1.class).forEach(view -> {
//			  System.out.println(view.getName() + " " + view.getCompany()); });
//												 
//		
		
		service.searchVaccineByCompany("russie", ResultView2.class).forEach(view -> {
			System.out.println(view.getRegNo() + " " + view.getCountry() + " " + view.getPrice());
		});
		
		
//		service.searchVaccineByCompany("moden", ResultView3.class).forEach(view -> {
