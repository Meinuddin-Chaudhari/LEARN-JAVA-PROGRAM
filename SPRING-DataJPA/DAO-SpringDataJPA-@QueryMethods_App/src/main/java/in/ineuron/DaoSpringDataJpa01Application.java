...
//		service.fetchVaccinesByCompany("mod").forEach(System.out::println);

//		service.fetchVaccinesByCompanies("ena", "moden").forEach(System.out::println);
//		System.out.println();

		List<Object[]> names = service.fetchVaccinesByName("sputnik", "pyzer");
