...
<%!Connection connection = null;
	...
	public void jspInit() {
		...
		try {
			...
			pstmt1 = connection.prepareStatement("insert into employees(ename,eaddr,esal) values (?,?,?)");
			pstmt2 = connection.prepareStatement("select eid,ename,eaddr,esal from employees");
